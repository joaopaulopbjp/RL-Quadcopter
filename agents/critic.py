...
class Critic:
    ...
    def build_model(self):
        ...
        net_states = layers.Dense(units=150, kernel_regularizer=layers.regularizers.l2(1e-6))(net_states)

        # Add hidden layer(s) for action pathway
        net_actions = layers.Dense(units=150,kernel_regularizer=layers.regularizers.l2(1e-6))(actions)
        ...
        Q_values = layers.Dense(units=1, name='q_values', 
                                ...
                                bias_initializer=initializers.RandomUniform(-0.003, 0.003)
                               )(net)
